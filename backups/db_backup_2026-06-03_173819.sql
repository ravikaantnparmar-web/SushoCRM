...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `password`, `phone`, `avatar`, `is_active`, `remember_token`, `reset_token`, `reset_token_expires`, `last_login`, `login_attempts`, `locked_until`, `created_at`, `updated_at`, `access_rights`) VALUES ('4', '2', 'Ravikant Parmar', 'ravikaant@sushobha.com', '$2y$12$sqR4oPuMeUdXvbJSXJCes.CJOnf.YAShRRKoqMaMDbry34w0bupBG', '+91 80123 45678', NULL, '1', NULL, NULL, NULL, '2026-06-03 17:31:37', '0', NULL, '2026-05-31 06:13:12', '2026-06-03 17:31:37', '[\"Read\",\"Write\",\"Modify\",\"Delete\",\"View\",\"Approve\"]');
